...
export const metadata: Metadata = {
  title: "Refund Policy — Career Brownie",
};
      ...
      <div className="container-custom py-16 max-w-4xl">
        ...
        <div className="space-y-8">
          {[
            ...
            { title: "3. Study Abroad Packages", content: "Study abroad consulting packages are refundable within 7 days of purchase if no services have been delivered. Once document review, university shortlisting, or SOP work has begun, a partial refund may be issued based on work completed, at Career Brownie's discretion." },
            { title: "4. How to Request a Refund", content: "Email refunds@careerbrownie.com with your order ID and reason. We process all refund requests within 3 business days. Approved refunds are credited back to the original payment method within 5–7 business days." },
